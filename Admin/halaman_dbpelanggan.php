...
<p>
    <a href="halaman_input_dbpelanggan.php">
    ...
    <tbody>
        ...
        if($katakunci !=''){
            ...
            for($x=0;$x < count($array_katakunci);$x++){
                $sqlcari[] = "(id_pelanggan like '%".$array_katakunci[$x]."%' || id_pelanggan like '%".$array_katakunci[$x]."%' || id_buku like '%".$array_katakunci[$x]."%')";
            }
        ...
        ?>
            ...
            <td>
                ...
                <a href="halaman_input_dbpelanggan.php?id=<?= $r1['id_pelanggan']?>"  class="text-decoration-none text-light" >
                        Edit
                </a>
                </span>
